...
public class teste-slide-122 extends JFrame
{
	private JButton btnVerificar = new JButton();
	private JLabel jLabel1 = new JLabel();
	private JTextField txfSentenca = new JTextField();
	private String[] alfabeto = {"b", "a"};
	private String[] estados = {"1", "2"};
	private String[] estadosReconhecedores = {"2"};
	private String[][] matrizTransicao = new String[2][2];
	private String estadoInicial = "1";
	...
	private void inicializaAutomato()
	{
		...
		matrizTransicao[0][0] = "2";  //<1> ::= b<2>
		matrizTransicao[0][1] = "2";  //<2> ::= b<2>
		matrizTransicao[1][0] = "1";  //<1> ::= a<1>
		matrizTransicao[1][1] = "2";  //<2> ::= a<2>
	}
	...
	{
		teste-slide-122 f1 = new teste-slide-122();
